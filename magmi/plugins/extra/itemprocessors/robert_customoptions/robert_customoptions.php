 ...
 */
class RobertCustomOptionsItemProcessor extends Magmi_ItemProcessor
{
    private $_dataColumn = "robert_custom_options";
    ...
    {
        return array("name"=>"Robert Custom Options","author"=>"Robert & Pablo & Dweeves","version"=>"0.0.7a",
    ...
    {
        if(in_array($this->_dataColumn, $cols)){
            $this->_active = true;
        } else {
            $this->log("column $this->_dataColumn not found in datasource, Robert Custom Options processor disabled", "startup");
        }
        return true;
    }
}
